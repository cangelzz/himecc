...
from common import tracking, page_404, copyright, myHeader, myFooter
...
def _board(path):
        ...
        if curPage == 1:
            navlink = "<h1 class='nav'><a class='btnLeft0' href='javascript:history.go(-1)'>&lt;</a><a href='/jj/' class=' btnCenter3 btnCenter' style='{width:66px}'>Home</a><a href='/jjboard/%s/2' class='btnRight0'>2</a></h1>" % board;
        else:
            nextPage = curPage + 1
            lastPage = curPage - 1
...
def _subject(path):
        ...
        boardLink = "<a class='btnCenter' href='/jjboard/%s' style='{width:%dpx}'>%s</a>" % (board, len(boardname)*8, boardname)
